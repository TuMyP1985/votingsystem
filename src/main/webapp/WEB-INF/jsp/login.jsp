...
<nav class="navbar navbar-dark bg-dark py-0">
    <div class="container">
        <div class="navbar-brand"><img src="resources/images/icon-restaurant.png"> <spring:message code="app.title"/></div>
...
<div class="jumbotron py-0">
    <div class="container">
        ...
        <br/>
        <p>
            <button type="submit" class="btn btn-lg btn-primary" onclick="login('User1', 'password1')">
                <spring:message code="app.login"/> User
            </button>
            <button type="submit" class="btn btn-lg btn-primary" onclick="login('Admin', 'passwordA')">
