...
<div class="jumbotron py-0">
    <div class="container">
        ...
        <sec:authorize access="isAnonymous()">
            <div class="pt-2">
                <button type="submit" class="btn btn-lg btn-primary mt-2" onclick="login('User1', 'password1')">
                    <spring:message code="app.login"/> User
                </button>
                <button type="submit" class="btn btn-lg btn-primary mt-2" onclick="login('Admin', 'passwordA')">
